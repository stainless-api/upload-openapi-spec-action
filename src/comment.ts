...
export function printComment({
  ...
  const fullComment = MD.Dedent`
    ...
    ${MD.Italic(
      `This comment is auto-generated by ${getCITerm()} and is automatically kept up to date as you push. ` +
        `To regenerate it for the current commit, ${MD.Link({
          text: `re-run the workflow.`,
          href: getRunUrl(),
        })}.` +
