...
describe("printComment", () => {
  ...
  it("should print no changes comment", () => {
    expect(printComment({ noChanges: true })).toMatchInlineSnapshot(`
      ...
      <i>This comment is auto-generated by GitHub Actions and is automatically kept up to date as you push. To regenerate it for the current commit, <a href="https://github.com/test/test/actions/runs/1">re-run the workflow.</a>.<br/>Last updated: 2000-01-01 00:00:00 UTC</i>"
    `);
  });
