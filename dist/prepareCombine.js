...
async function combineSpecs(files, outputPath, serverStrategy) {
  ...
  const tempDir = serverStrategy ? path5.join(path5.dirname(outputPath), ".temp-combine") : null;
  try {
